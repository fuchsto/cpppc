...
public:
  ...
  //   is typically a disaster.When a class is a resource handle, that is,
  //   it is responsible for an object accessed through a pointer, the
  //   default memberwise copy is typically a disaster."
  //                                              -- B. Stroustrup, TCppPL
